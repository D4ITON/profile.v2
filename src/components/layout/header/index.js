    ...
    <React.Fragment>
      ...
      <div className="input-change-theme">
        <label htmlFor="inputTheme">
          {!context.darkmode ? (
            <ICON.MOON width={20} height={21} />
          ) : (
            <ICON.SUN width={22.5} height={22.5} />
          )}
        </label>
        <input
          type="checkbox"
          ...
          onChange={(e) => context.handleChangeDarkMode(e)}
        />
      </div>
      ...
      <div className="header">
        <div className="h-image">
          <img
            src="https://dl.dropboxusercontent.com/s/gl8h35m3bscxz3i/mobile-fondo.jpg?dl=0"
            alt="profile"
          />
        </div>
        ...
        <div className="h-button">
          <a
            href="https://drive.google.com/file/d/1Mlbv8VNxqogkQLvrn2f4_szODQVJ8NEp/view?usp=sharing"
            target="_blank"
