      ...
      <div className="f-content">
        ...
        <div className="f-hello">
          ...
          <div className="f-h-link">
            <a href="https://github.com/D4ITON">
              <ICON.GITHUB width={30} height={30} />
            </a>
            <a href="https://www.linkedin.com/in/dalthonmh">
              <ICON.LINKEDIN width={30} height={30} />
            </a>
            <a href="https://twitter.com/dalthonmamani">
              <ICON.TWITTER width={30} height={30} />
            </a>
            <a href="https://medium.com/@dalthonmamani">
              <ICON.MEDIUM width={30} height={30} />
            </a>
            <a href="https://stackoverflow.com/users/9868383">
              <ICON.STOF width={30} height={30} />
            </a>
          </div>
        </div>
      </div>
